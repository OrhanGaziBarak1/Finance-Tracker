...
public class ExpenseSourceController {
  ...
  @GetMapping("/{id}")
  public ResponseEntity<ExpenseSourceDTO> getOne(
  ...
  @PostMapping
  public ResponseEntity<ExpenseSourceDTO> create(
      @RequestBody @Valid ExpenseSourceDTO dto,
      @AuthenticationPrincipal SecurityUserDetailsService.UserPrincipal principal
  ) {
